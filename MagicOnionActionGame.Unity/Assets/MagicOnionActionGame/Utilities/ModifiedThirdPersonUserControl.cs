...
namespace MagicOnionExample.ActionGame
{
    ...
    public class ModifiedThirdPersonUserControl : MonoBehaviour
    {
        ...
        public delegate void OnCharacterMoveHandler(Vector3 position, Quaternion rotation, Vector3 move, bool crouch, bool jump);
        public OnCharacterMoveHandler OnUpdateCharacterMove;


        private void UpdateCharacterMove()
        {
            OnUpdateCharacterMove?.Invoke(transform.position, transform.rotation, m_Move, m_Crouch, m_Jump);
        ...
        private void FixedUpdate()
        {
            ...
            m_Crouch = Input.GetKey(KeyCode.C); // Modified by sotanmochi
            ...
            UpdateCharacterMove(); // Modified by sotanmochi
